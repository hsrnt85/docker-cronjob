...
//------------------------------------------------------------------------------------------------------------------------------------------------
//Pegawai Kewangan
Route::group(['prefix' => 'PegawaiKewangan'], function () {
    //PAGE
...
Route::group(['prefix' => 'PenyesuaianAkauniGFMAS'], function () {
    //PAGE
    Route::get('Senarai', [AccountReconciliationIgfmasController::class, 'list'])->name('accountReconciliationIgfmas.list');
    ...
    Route::get('SenaraiItem', [AccountReconciliationIgfmasController::class, 'listItem'])->name('accountReconciliationIgfmas.listItem');
    Route::get('CetakResit', [AccountReconciliationIgfmasController::class, 'cetakResit'])->name('accountReconciliationIgfmas.cetakResit');
    //PROCESS
    Route::post('Proses', [AccountReconciliationIgfmasController::class, 'process'])->name('accountReconciliationIgfmas.process');
});
