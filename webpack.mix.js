 ...
 */
    ...
    var third_party_assets = {
        css_js: [
            ...
            {"name": "select2", "assets": ["./resources/libs/select2/select2.min.js", "./resources/libs/select2/select2.min.css"]},
    ...
    var app_pages_assets = {
        js: [
            folder.src + "js/libs/apexcharts.init.js",
            folder.src + "js/libs/auth-2-carousel.init.js",
            folder.src + "js/libs/calendars-full.init.js",
            folder.src + "js/libs/calendar.init.js",
            folder.src + "js/libs/chartjs.init.js",
            folder.src + "js/libs/coming-soon.init.js",
            folder.src + "js/libs/crypto-dashboard.init.js",
            folder.src + "js/libs/crypto-exchange.init.js",
            folder.src + "js/libs/crypto-kyc-app.init.js",
            folder.src + "js/libs/crypto-orders.init.js",
            folder.src + "js/libs/crypto-wallet.init.js",
            folder.src + "js/libs/dashboard.init.js",
            folder.src + "js/libs/dashboard-blog.init.js",
            folder.src + "js/libs/datatables.init.js",
            folder.src + "js/libs/echarts.init.js",
            folder.src + "js/libs/ecommerce-cart.init.js",
            folder.src + "js/libs/ecommerce-select2.init.js",
            folder.src + "js/libs/email-editor.init.js",
            folder.src + "js/libs/file-manager.init.js",
            folder.src + "js/libs/flot.init.js",
            folder.src + "js/libs/fontawesome.init.js",
            folder.src + "js/libs/form-advanced.init.js",
            folder.src + "js/libs/form-editor.init.js",
            folder.src + "js/libs/form-mask.init.js",
            folder.src + "js/libs/form-repeater.int.js",
            folder.src + "js/libs/form-validation.init.js",
            folder.src + "js/libs/form-wizard.init.js",
            folder.src + "js/libs/form-xeditable.init.js",
            folder.src + "js/libs/gmaps.init.js",
            folder.src + "js/libs/ico-landing.init.js",
            folder.src + "js/libs/jquery-knob.init.js",
            folder.src + "js/libs/leaflet-map.init.js",
            folder.src + "js/libs/lightbox.init.js",
            folder.src + "js/libs/materialdesign.init.js",
            folder.src + "js/libs/product-filter-range.init.js",
            folder.src + "js/libs/profile.init.js",
            folder.src + "js/libs/project-overview.init.js",
            folder.src + "js/libs/range-sliders.init.js",
            folder.src + "js/libs/rating-init.js",
            folder.src + "js/libs/saas-dashboard.init.js",
            folder.src + "js/libs/session-timeout.init.js",
            folder.src + "js/libs/sparklines.init.js",
            folder.src + "js/libs/sweet-alerts.init.js",
            folder.src + "js/libs/table-editable.int.js",
            folder.src + "js/libs/table-responsive.init.js",
            folder.src + "js/libs/task-create.init.js",
            folder.src + "js/libs/task-form.init.js",
            folder.src + "js/libs/task-kanban.init.js",
            folder.src + "js/libs/tasklist.init.js",
            folder.src + "js/libs/timeline.init.js",
            folder.src + "js/libs/toastr.init.js",
            folder.src + "js/libs/tui-charts.init.js",
            folder.src + "js/libs/two-step-verification.init.js",
            folder.src + "js/libs/validation.init.js",
            folder.src + "js/libs/vector-maps.init.js"
        ]
    };
    ...
    // mix.combine('resources/js/libs/calendars.js', folder.dist_assets + "js/libs/calendars.js");
    // mix.combine('resources/js/libs/schedules.js', folder.dist_assets + "js/libs/schedules.js");
    // mix.combine('resources/js/libs/leaflet-us-states.js', folder.dist_assets + "js/libs/leaflet-us-states.js");
    // custom swal
    mix.combine('resources/js/swal.js', folder.dist_assets + "js/swal.js");
    mix.combine('resources/js/datatablesBm.js', folder.dist_assets + "js/datatablesBm.js");
    mix.combine('resources/js/pages/Application/application.js', folder.dist_assets + "js/pages/Application/application.js");
    mix.combine('resources/js/pages/DistrictManagement/districtManagement.js', folder.dist_assets + "js/pages/DistrictManagement/districtManagement.js");
    mix.combine('resources/js/pages/Greenlane/greenlane.js', folder.dist_assets + "js/pages/Greenlane/greenlane.js");
    mix.combine('resources/js/pages/QuartersClass/quartersClass.js', folder.dist_assets + "js/pages/QuartersClass/quartersClass.js");
    mix.combine('resources/js/pages/SelectionCriteria/selectionCriteria.js', folder.dist_assets + "js/pages/SelectionCriteria/selectionCriteria.js");
    mix.combine('resources/js/pages/Inventory/inventory.js', folder.dist_assets + "js/pages/Inventory/inventory.js");