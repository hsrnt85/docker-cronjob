                                ...
                                <tbody>
                                    ...
                                    @foreach ($paymentNoticeScheduleAll as $i => $data)
                                        @php
                                            ...
                                            $process_status = ($data->flag_process == 1) ? "TELAH DIPROSES" : "";
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    @if(checkPolicy("U") && ($flag_process_previous || $loop->first)  && !$flag_process )
                                                        <a href="{{ route('paymentNoticeTransaction.listQuartersCategoryWithTenant', ['year' => $data->year, 'month' => $data->month]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
