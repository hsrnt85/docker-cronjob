            ...
            <div class="card-body">
                ...
                <div class="card ">
                    <form id="form" method="post" >
                        ...
                        @endphp
                        <div class="mb-3 row">
                            <label class="col-md-2 col-form-label">No. EFT</label>
                            <div class="col-md-4">{{ $eft_no }}</div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-md-2 col-form-label">Tarikh EFT</label>
                            <div class="col-md-4">{{ $eft_date }}</div>
                        </div>
