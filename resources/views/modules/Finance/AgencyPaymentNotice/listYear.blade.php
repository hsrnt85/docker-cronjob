                            ...
                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap w-100 dataTable" role="grid" >
                                <thead class="bg-primary bg-gradient text-white">
                                    <tr role="row">
                                        ...
                                        <th class="text-center">Tahun Notis Bayaran</th>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    @if(checkPolicy("U") || checkPolicy("V"))
                                                        <a href="{{ route('agencyPaymentNotice.listPaymentNotice', ['year' => $data->year]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
