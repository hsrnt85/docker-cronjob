...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <!-- section - search  -->
            <div class="card ">
                <form class="search_form" method="post" action="{{ route('agencyPaymentNotice.listTenant', ['year' => $year, 'month' => $month, 'oid'=> $organization->id ]) }}" >
                    {{ csrf_field() }}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div data-simplebar style="max-height: 1000px;">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12">
                                <a href="{{ route('agencyPaymentNotice.listAgencyWithTenant', ['year' => $year, 'month' => $month]) }}" class="btn btn-secondary float-end me-2">{{ __('button.kembali') }}</a>
                            </div>
                        </div>
