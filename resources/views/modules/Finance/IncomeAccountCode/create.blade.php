    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation" id="form" method="post" action="{{ route('incomeAccountCode.store') }}" >
                    {{ csrf_field() }}

                    <div class="mb-3 row">
                        <label for="salary_deduction_code" class="col-md-2 col-form-label">Kod Potongan Gaji</label>
                        <div class="col-md-10">
                            <input class="form-control @error('salary_deduction_code') is-invalid @enderror" type="text" name="salary_deduction_code" value="{{ old('salary_deduction_code', '') }}" required data-parsley-required-message="{{ setMessage('salary_deduction_code.required') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('general_income_code') is-invalid @enderror" type="text" name="general_income_code" value="{{ old('general_income_code', 'G001') }}" required data-parsley-required-message="{{ setMessage('general_income_code.required') }}" >
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('ispeks_account_code') is-invalid @enderror" type="text" name="ispeks_account_code" value="{{ old('ispeks_account_code', '') }}" required data-parsley-required-message="{{ setMessage('ispeks_account_code.required') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('ispeks_account_description') is-invalid @enderror" type="text" name="ispeks_account_description" value="{{ old('ispeks_account_description', '') }}" required data-parsley-required-message="{{ setMessage('ispeks_account_description.required') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('income_code') is-invalid @enderror" type="text" name="income_code" value="{{ old('income_code', '') }}" required data-parsley-required-message="{{ setMessage('income_code.required') }}">
                            @error('income_code')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('income_code_description') is-invalid @enderror" type="text" name="income_code_description" value="{{ old('income_code_description', '') }}" required data-parsley-required-message="{{ setMessage('income_code_description.required') }}">
                        ...
                        <div class="col-md-10">
                            <select class="form-select @error('account_type') is-invalid @enderror" name="account_type" required data-parsley-required-message="{{ setMessage('account_type.required') }}">
                                ...
                                @foreach($accountTypeAll as $accountType)
                                    <option value="{{$accountType->id }}" @if($accountType->id == old('account_type')) selected @endif>{{$accountType->account_type}}</option>
                                @endforeach
                            </select>
                            @error('account_type')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-select @error('payment_category') is-invalid @enderror" name="payment_category" required data-parsley-required-message="{{ setMessage('payment_category.required') }}">
                                <option value="">-- Pilih Kategori Bayaran --</option>
                                @foreach($paymentCategoryAll as $category)
                                    <option value="{{$category->id }}" @if($category->id == old('payment_category')) selected @endif>{{$category->payment_category}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            @foreach($servicesStatusAll as $i => $servicesStatus)
                                <span class="form-check d-flex  @error('services_status') is-invalid @enderror">
                                    <input class="services_status form-check-input me-2" type="checkbox"
                                        ...
                                        {{ (old('services_status.'.$i) == $servicesStatus->id) ? "checked" : "" }}
                            ...
                            {{-- <div class="form-check @error('flag_pensioner') is-invalid @enderror">
                                ...
                                value="1" {{ old('flag_pensioner') == 1 ? "checked" : "" }} data-parsley-required-message="{{ setMessage('flag_pensioner.required') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-1">
                            <div class="form-check @error('flag_outstanding') is-invalid @enderror">
                                <input class="flag_outstanding form-check-input me-2" type="checkbox" id="formCheck" name="flag_outstanding" value="2" {{ old('flag_outstanding') == 2 ? "checked" : "" }}>
