...
<div class="row">
    ...
    <div class="col-md-9">
        <table class="table table-sm table-bordered" id="table-anak-list">
            ...
            <tbody>
                @if ($application->selected_category()->count() > 0)
                    <tr>
                        <td class="text-center">1</td>
                        <td class="text-center">{{ $application->selected_category()->name}} </td>
                        <td class="text-center">{{ $application->selected_category()->district?->district_name }}</td>
                    </tr>
                @endif
            </tbody>
        </table>
...
<h4 class="card-title text-primary">Dokumen yang telah dimuat naik</h4>
        ...
        <table class="table table-sm table-bordered" id="table-anak-list">
            <thead class="text-white bg-primary">
                <tr>
                    ...
                    <th class="text-center">Dokumen</th>
                    <th class="text-center" width="12%">Papar</th>
                </tr>
            </thead>
            <tbody>
                @foreach($quartersAcceptanceAttachmentAll as $attachment)
                    <tr>
                        <td class="text-center">{{ $loop->iteration }}</td>
                        <td class="text-center">{{ $attachment->document->document_name }}</td>
                        <td class="text-center">
                            <a download="{{ $attachment->document->document_name }}" target="_blank" href="{{ $cdn . $attachment->path_document }}"
                            class="btn btn-outline-primary tooltip-icon" title="{{ $attachment->document->document_name }}"><i class="{{ __('icon.view_file') }}"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
