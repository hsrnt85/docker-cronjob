...
<input type="hidden" id="flag" value="{{$flag_page}}">
...
<div  style="text-align: center;">
    ...
    @else
        @foreach($complaintInventoryAttachment as $inventory_attachment)
            ...
            <img src="{{ getCdn().'/'.$inventory_attachment->path_document }}" class="mb-1" width= "50px" height="50px" onclick="showInventoryImage(this,{{ $inventory_attachment->id }});"  style="border: 1px solid black">
        @endforeach
    @endif
</div>
