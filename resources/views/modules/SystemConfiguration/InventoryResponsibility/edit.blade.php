    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation" id="form" method="post" action="{{ route('inventoryResponsibility.update') }}" >
                    {{ csrf_field() }}

                    <input class="form-control" type="hidden" id="id" name="id" value="{{ $inventoryResponsibility->id }}">

                    <div class="mb-3 row">
                        <label for="name" class="col-md-2 col-form-label">Jabatan Bertanggungjawab (Inventori)</label>
                        <div class="col-md-10">
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name',$inventoryResponsibility->name) }}"
