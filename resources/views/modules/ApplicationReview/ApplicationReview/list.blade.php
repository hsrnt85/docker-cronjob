                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            @if(checkPolicy("U"))
                                                                <a href="{{ route('applicationReview.review', ['id' => $application->id, 'qcid' => $application->quarters_category_id]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
                                            ...
                                            @foreach ($applicationHistoryAll as $application)
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-center" width="10%">
                                                        <div class="btn-group" role="group">
                                                            @if(checkPolicy("V"))
                                                                <a href="{{ route('applicationReview.view', ['id' => $application->id, 'qcid' => $application->quarters_category_id]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
