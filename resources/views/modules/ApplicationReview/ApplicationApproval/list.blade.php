                ...
                <div class="tab-content pt-3">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive wrap w-100 dataTable" role="grid" >
                                        <thead class="bg-primary bg-gradient text-white">
                                            <tr role="row">
                                                ...
                                                <th width="25%" class="text-center" >Kategori Kuarters (Lokasi)</th>
                                                <th class="text-center" >Tarikh Hantar</th>
                                                <th class="text-center" >Markah</th>
                                                <th class="text-center" >Disemak Oleh</th>
                                        ...
                                        <tbody>
                                            @foreach ($applicationAll as $application)
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-center">{{ $application->reviewed_by() ?? '' }}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            @if(checkPolicy("U"))
                                                                <a href="{{ route('applicationApproval.edit', ['id' => $application->id, 'qcid' => $application->quarters_category_id]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
                    ...
                    <div class="tab-pane mb-3" id="application-history" role="tabpanel">
                        ...
                        <div id="datatable_wrapper">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatable2" class="table table-striped table-bordered dt-responsive wrap w-100 dataTable"  >
                                        <thead class="bg-primary bg-gradient text-white">
                                            <tr >
                                                <th width="5%" class="text-center" width="4%">Bil</th>
                                                <th width="20%" class="text-center" >Pemohon</th>
                                                <th width="20%" class="text-center" >Kategori Kuarters (Lokasi)</th>
                                                <th width="5%" class="text-center" >Tarikh</th>
                                                <th width="5%" class="text-center" >Markah</th>
                                                <th width="20%" class="text-center" >Diluluskan Oleh</th>
                                                <th width="20%" class="text-center" >Status</th>
                                                <th width="5%" class="text-center" width="10%">Tindakan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($applicationHistoryAll as $application)
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-center">{{ convertDateSys($application->application_date_time) }}</td>
                                                    <td class="text-center">{{ $application->scores->sum('mark') }}</td>
                                                    <td class="text-center">{{ $application->approved_by() ?? '' }}</td>
                                                    <td class="text-center">{{($application->application_status(5) ?? $application->application_status(6) ?? '')}}</td>
                                                    <td class="text-center" width="10%">
                                                        <div class="btn-group" role="group">
                                                            @if(checkPolicy("V"))
                                                                <a href="{{ route('applicationApproval.view', ['id' => $application->id, 'qcid' => $application->quarters_category_id]) }}" class="btn btn-outline-primary px-2 py-1 tooltip-icon">
...
@section('script')
<script src="{{ URL::asset('assets/js/pages/ApplicationReview/ApplicationApproval.js')}}"></script>
@endsection
