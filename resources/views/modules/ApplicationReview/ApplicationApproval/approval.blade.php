            ...
            <div class="card-body">
                ...
                <div class="tab-content p-0">
                    ...
                    <div class="tab-pane active" id="application_scoring" role="tabpanel">
                        ...
                        <form class="custom-validation" id="form-review" method="post" action="{{ route('applicationApproval.store') }}" >
                            {{ csrf_field() }}
                            ...
                            <div class="mt-3 mb-3 row">
                                <label for="name" class="col-md-2">Disemak Oleh</label>
                                <div class="col-md-6">
                                    {{$application->reviewed_by() ?? ''}}
                                </div>
                            </div>
                            <div class="mt-3 row">
                                <label for="application_status" class="col-md-2 col-form-label">Status Kelulusan</label>
                                <div class="col-md-9">
                            ...
                            <div class="mt-3 mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control @error('remarks')-invalid @enderror" rows="3" id="remarks" name="remarks" data-parsley-required-message="{{ setMessage('remarks.required') }}"></textarea>
                    ...
                    <div class="tab-pane" id="application_info" role="tabpanel">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-11 offset-sm-1">
                                <a href="{{ route('applicationApproval.index') . '#' . $tab }}" class="btn btn-secondary float-end">{{ __('button.kembali') }}</a>
                            </div>
                        </div>
