        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content p-0">
                    ...
                    <div class="mt-3 mb-3 ms-2 row">
                        <label for="name" class="col-md-2">Status Kelulusan</label>
                        <div class="col-md-6">
                            {{($application->application_status(5) ?? $application->application_status(6) ?? '')}}
                        </div>
                    </div>
                    @if($applicationReview->remarks)
                        <div class="mt-3 mb-3 ms-2 row">
                    ...
                    @endif
                    <div class="mt-3 mb-3 ms-2 row">
                        <label for="name" class="col-md-2">Diluluskan Oleh</label>
                        <div class="col-md-6">
