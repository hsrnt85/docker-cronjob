...
class AcceptController extends Controller
{
    public function index()
    {
        ...
        $acceptedOfferAppAll = Application::getAcceptedOffer($district_id);

        return view( getFolderPath().'.list',
        [
            'acceptedOfferAppAll' => $acceptedOfferAppAll,
        ]);
    }

    public function show(Application $application)
    {
        //$acceptedOfferApp = Application::getAcceptedOfferChecked($application->id);
